...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
	...
	<link rel="stylesheet" type="text/css" href="css_js/sweetalert.min.css">
  </head>
        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            ...
            <ul class="nav navbar-nav float-xs-right">
              ...
              <li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" class="nav-link nav-link-label"><i class="ficon icon-bell4"></i><span class="tag tag-pill tag-default tag-danger tag-default tag-up">
			  
			  <?php 
				include('con_sever.php');
				$strSQL = "SELECT count(*) as countsroom FROM room";
				$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
				$objResult = mysql_fetch_array($objQuery);

				echo $objResult['countsroom'];
				?>
              ...
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="../../app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name">
                ...
                <div class="dropdown-menu dropdown-menu-right"><a href="#" class="dropdown-item"><i class="icon-head"></i> Edit Profile</a><a href="#" class="dropdown-item"><i class="icon-mail6"></i> My Inbox</a><a href="#" class="dropdown-item"><i class="icon-clipboard2"></i> Task</a><a href="#" class="dropdown-item"><i class="icon-calendar5"></i> Calender</a>
                  <div class="dropdown-divider"></div><a href="logoutpage.php" class="dropdown-item"><i class="icon-power3"></i> Logout</a>
                </div>
              </li>
            </ul>
          </div>
        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class=" nav-item"><a href="index.html"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Dashboard</span><span class="tag tag tag-primary tag-pill float-xs-right mr-2">2</span></a>
            <ul class="menu-content">
              ...
              <li><a href="dashboard-2.php" data-i18n="nav.dash.main" class="menu-item">Dashboard 2</a>
              </li>
            </ul>
          </li>
          ...
          <li class=" nav-item"><a href="#"><i class="icon-briefcase4"></i><span data-i18n="nav.project.main" class="menu-title">Pages</span></a>
            <ul class="menu-content">
              ...
              <li><a href="login-page.php" data-i18n="nav.login_register_pages.login_simple" class="menu-item">Login Page</a>
              </li>
                    ...
                    <div class="media">
                        <div class="media-body text-xs-left">
                            ...
                            <h3 class="pink">
										...
										<?php 
										$objConnect = mysql_connect("mtls7.biz","layer_view","mtc@MTC1234") or die("Error Connect to Database");
										$objDB = mysql_select_db("layer_flow");
										$strSQL = "SELECT count(*) as counts FROM bakcust_1260";
										$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
										$objResult = mysql_fetch_array($objQuery);
										echo $objResult['counts'];
										?>
                    ...
                    <div class="media">
                        <div class="media-body text-xs-left">
							...
							<?php 
										$objConnect = mysql_connect("mtls7.biz","layer_view","mtc@MTC1234") or die("Error Connect to Database");
										$objDB = mysql_select_db("layer_flow");
										$strSQL = "SELECT count(*) as counts FROM custlaw_1160";
										$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
										$objResult = mysql_fetch_array($objQuery);
										echo $objResult['counts'];
							?>
                    ...
                    <div class="media">
                        <div class="media-body text-xs-left">
							...
							<?php 
										$objConnect = mysql_connect("mtls7.biz","layer_view","mtc@MTC1234") or die("Error Connect to Database");
										$objDB = mysql_select_db("layer_flow");
										$strSQL = "SELECT count(*)/2 as counts FROM custlaw_1160";
										$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
										$objResult = mysql_fetch_array($objQuery);
										echo $objResult['counts'];
							?>
...
<div class="row match-height">
    ...
    <div class="col-xl-8 col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-block">
                    <p>Total paid invoices 240, unpaid 150. <span class="float-xs-right"><a href="#" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">
					add data <i class="icon-arrow-right2"></i></a></span></p>
					...
					<div class="modal-content">
					  ...
					  <div class="modal-body">
					   ...
					   <div class="modal-footer">
								...
								<button type="submit" name="save" class="btn btn-primary"  id="butsave">add data</button>
						</div>
						</form>
							</div>
						  </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0" id="employeeList">
                        <thead>
                            <tr>
                                <th>Invoice#</th>
                                <th>Customer Name</th>
				...
				?>
                            <tr>
								<td class="text-truncate"><a href="#">INV- <?php echo $row['id'];?> </a></td>
                                <td class="text-truncate"><?php echo $row['name'];?></td>
                                <td class="text-truncate"><span class="tag tag-default tag-success">Paid</span></td>
                                <td class="text-truncate"><?php echo $row['idf'];?></td>
								<td> 
							
									<button type="button" name="update" id="<?php echo $row["id"] ?>" 
									class="btn btn-warning btn-xs update" data-toggle="modal" data-keyboard="false" data-backdrop="static" data-target="#update_country"
									data-id="<?=$row['id'];?>">Update</button>
									 <button type="button" name="delete" id="<?php echo $row["id"] ?>" class="btn btn-danger btn-xs delete" >Delete</button>
								</td>	
				
				
				<!-- Modal -->
				<div class="modal fade" id="update_country" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					...
					<div class="modal-content">
					  ...
					  <div class="modal-body">
							...
							<div class="form-group">
								...
								<input type="text" name="name_modal" id="name_modal" 
								class="form-control square" placeholder="<?php echo $row["name"] ?>" 
					  ...
					  <div class="modal-footer">
						...
						<button type="submit" class="btn btn-primary" id="update_data">
...
$(document).ready(function() {
	...
	$(document).on("click", "#update_data", function() { 
		$.ajax({
			...
			success: function(dataResult){
				var dataResult = JSON.parse(dataResult);
				swal({title: "data updated successfully", text: "You clicked the button!", type: "success"},
				   function(){ 
					   location.reload();
				   }
				);
